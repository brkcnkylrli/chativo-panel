...
<template>
  ...
  >
    ...
    >
      <ul class="flex flex-col gap-1 m-0 list-none min-w-0">
        <SidebarGroup
    ...
    >
      <div
        class="pointer-events-none absolute inset-x-0 -top-[1.938rem] h-8 bg-gradient-to-t from-n-sidebar to-transparent"
      />
      ...
      >
        ...
        <SidebarAsistanim
          ...
          bolum="paket"
          etiket="SIDEBAR.ABONELIGIM"
          ikon="i-lucide-credit-card"
        />
      </div>
      <div
