<script setup>
import { isVNode, computed, inject } from 'vue';
...
// Mobilde bir sayfaya gidildiginde menu kapanmali; masaustunde bu deger
// tanimsiz ve hicbir sey olmuyor.
const mobilMenuyuKapat = inject('mobilMenuyuKapat', null);
</script>
