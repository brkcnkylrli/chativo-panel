...
// Giden mesajlar eskiden dolu mavi/mor blok halindeydi; uzun cevaplarda ekran
// tek renge boguluyordu. Simdi hepsi ayni dusuk doygunluklu marka tonunda:
// gelen-giden ayrimi hizalama ve avatar uzerinden okunuyor, dolgu rengi
// uzerinden degil.
const varaintBaseMap = {
  [MESSAGE_VARIANTS.AGENT]: 'bg-n-violet-3 text-n-slate-12',
  [MESSAGE_VARIANTS.PRIVATE]:
    'bg-n-solid-amber text-n-amber-12 [&_.prosemirror-mention-node]:font-semibold',
  // Gelen balon notr griydi; zemin mor tonlu olunca aileden dusuyordu.
  [MESSAGE_VARIANTS.USER]: 'bg-n-solid-2 text-n-slate-12',
  [MESSAGE_VARIANTS.ACTIVITY]: 'bg-n-alpha-1 text-n-slate-11 text-sm',
  [MESSAGE_VARIANTS.BOT]: 'bg-n-violet-3 text-n-slate-12',
  [MESSAGE_VARIANTS.TEMPLATE]: 'bg-n-violet-3 text-n-slate-12',
