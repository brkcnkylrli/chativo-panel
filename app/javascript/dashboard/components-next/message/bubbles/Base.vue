...
// Zemin saf siyah oldugu icin giden balon marka morunu tasiyabiliyor: siyah
// uzerinde net okunuyor ve renk arayuzde yalnizca burada ve vurguda kaliyor.
// Gelen balon notr koyu gri.
const varaintBaseMap = {
  [MESSAGE_VARIANTS.AGENT]: 'bg-n-violet-4 text-n-slate-12',
  [MESSAGE_VARIANTS.PRIVATE]:
    'bg-n-solid-amber text-n-amber-12 [&_.prosemirror-mention-node]:font-semibold',
  [MESSAGE_VARIANTS.USER]: 'bg-n-solid-2 text-n-slate-12',
  [MESSAGE_VARIANTS.ACTIVITY]: 'bg-n-alpha-1 text-n-slate-11 text-sm',
  [MESSAGE_VARIANTS.BOT]: 'bg-n-violet-4 text-n-slate-12',
  [MESSAGE_VARIANTS.TEMPLATE]: 'bg-n-violet-4 text-n-slate-12',
